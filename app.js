...
var incompleteTaskHolder = document.querySelector(".task-list__incompleted"); //ul of #incompletetasks
var completedTasksHolder = document.querySelector(".task-list__completed"); //completed-tasks
